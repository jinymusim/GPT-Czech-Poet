...
cd $SCRATCHDIR
pip install --target=$SCRATCHDIR -r /storage/brno2/home/tf_shorts/Tensorflow-Shorts/DialogSystem/requirements.txt
export PYTHONPATH="${PYTHONPATH}:${TMPDIR}"
cd /storage/brno2/home/tf_shorts/Tensorflow-Shorts/DialogSystem
