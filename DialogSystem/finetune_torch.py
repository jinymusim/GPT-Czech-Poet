...
parser.add_argument("--epochs", default=2, type=int, help="Number of Epochs to finetune")
parser.add_argument("--learning_rate", default=1e-6, type=float, help="Learning rate for finetune")
