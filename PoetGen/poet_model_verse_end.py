...
class PoetModelVerseEnd(PoetModelInterface):
    def __init__(self, pretrainedModel, *args, **kwargs) -> None:
        ...
        self.verse_endings = torch.nn.Linear(self.model_size, len(verse_ending))
        
        
    def forward(self, input_ids=None, labels=None, attention_mask=None, vowel_count=None, rhyme=None, verse_end = None, *args, **kwargs):
