...
parser.add_argument("--max_len_rhyme", default=32, type=int, help="Max length for tokenizer")
...
parser.add_argument("--n_embd_rhyme", default=64, type=int, help="Max length for tokenizer")
...
def main(args):
    ...
    rhyme_model = RhymeValidator(block_count=args.block_count, n_embd=args.n_embd_rhyme, input_size=args.max_len_rhyme)
    ...
    collate_rhyme = partial(CorpusDatasetPytorch.collate_rhyme, tokenizer=tokenizer,max_len=args.max_len_rhyme)
