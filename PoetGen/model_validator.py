...
parser.add_argument("--model_path_full", default=os.path.abspath(os.path.join(os.path.dirname(__file__),'backup_LMS', "Unicode-Tokenizer-NormalText-gpt-cz-poetry-base-e4e8_LM")),  type=str, help="Path to Model")
