...
parser.add_argument("--model_path_full", default=os.path.abspath(os.path.join(os.path.dirname(__file__),'backup_LMS', "gpt2-cz-poetry-context_e8_e32")),  type=str, help="Path to Model")
