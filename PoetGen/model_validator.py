...
parser.add_argument("--default_tokenizer_model", default="bigscience/bloom-560m", type=str, help="Default Model from HF to use")
...
parser.add_argument("--model_path_full", default=os.path.abspath(os.path.join(os.path.dirname(__file__),'backup_LMS', "bloom-cz-poetry-secondary_e8_e16_endings")),  type=str, help="Path to Model")
