...
parser.add_argument("--model_path_full", default=os.path.abspath(os.path.join(os.path.dirname(__file__),'backup_LMS', "Syllabs-BPE-NormalText-gpt-cz-poetry-base-e16e16")),  type=str, help="Path to Model")
