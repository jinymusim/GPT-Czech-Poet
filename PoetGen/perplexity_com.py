...
parser.add_argument("--num_runs", default=1000, type=int, help="Number of runs per setting")
...
ground = [datum['input_ids'] for datum in sampled_data]
generated_basic = [decoder_helper("BASIC", datum['rhyme'], datum['year'], datum['metre_ids'][0]) for datum in sampled_data]
generated_forced = [decoder_helper("FORCED", datum['rhyme'], datum['year'], datum['metre_ids'][0]) for datum in sampled_data]
