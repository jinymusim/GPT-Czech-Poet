...
parser.add_argument("--default_tokenizer_model", default=os.path.abspath(os.path.join(os.path.dirname(__file__), "utils", "tokenizers", "Unigram", "processed_tokenizer.json")), type=str, help="Tokenizer to use")
