...
parser.add_argument("--epochs_poet", default=20, type=int, help="Number of epochs for poet gen")
...
parser.add_argument("--train_for_consistency", default=False, type=bool, help="Train for consistency secondary training")
