...
parser.add_argument("--model_path_full", default=os.path.abspath(os.path.join(os.path.dirname(__file__), "gpt-cz-poetry-secondary_e2_e4_verse_len_4_6")),  type=str, help="Path to Model")
parser.add_argument("--model_path_LM", default=os.path.abspath(os.path.join(os.path.dirname(__file__), "gpt-cz-poetry-secondary_e2_e4_verse_len_4_6_LM")),  type=str, help="Path to Model")
