...
parser.add_argument("--model_path_full", default=os.path.abspath(os.path.join(os.path.dirname(__file__),'backup_LMS', "CZ-New-Syllable-BPE-NormalText-gpt-cz-poetry-all-e4e8_LM")),  type=str, help="Path to Model")
