...
parser.add_argument("--model_path_full", default=os.path.abspath(os.path.join(os.path.dirname(__file__),'backup_LMS', "BPE-gpt-cz-poetry-all-e128e128")),  type=str, help="Path to Model")
