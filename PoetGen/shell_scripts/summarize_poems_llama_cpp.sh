...
CMAKE_ARGS="-DLLAMA_CUBLAS=on -DCMAKE_CUDA_ARCHITECTURES=60;61;70;75;80;86;90" FORCE_CMAKE=1 pip install --target=$SCRATCHDIR llama-cpp-python --no-cache-dir --force-reinstall
