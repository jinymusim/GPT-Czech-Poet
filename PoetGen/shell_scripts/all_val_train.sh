...
qsub -N TrainVal -q gpu_dgx -l select=1:ncpus=4:ngpus=4:mem=40gb:gpu_mem=30gb:scratch_local=64gb -l walltime=300:00:00 -v 'EPMETER=64, EPRHYME=64, EPYEAR=64, TOK=roberta-base,  MODEL=roberta-base, SYLAB=true, SAM=false, CONTEXT=true'  shell_scripts/all_val_train_helper.sh
