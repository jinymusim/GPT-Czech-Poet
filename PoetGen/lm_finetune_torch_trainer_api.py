...
parser.add_argument("--model_path", default=os.path.abspath(os.path.join(os.path.dirname(__file__), "gpt2-cz-poetry-verse_e64_e128")),  type=str, help="Path to Model")
