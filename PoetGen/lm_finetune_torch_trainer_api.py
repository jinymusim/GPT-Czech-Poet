...
parser.add_argument("--model_type",  default="verse", type=str, choices=["base", "secondary_tasks", "half", "verse", "context", "year"], help="What type of Model is to be constructed")
parser.add_argument("--model_path", default=os.path.abspath(os.path.join(os.path.dirname(__file__), "gpt-cz-poetry-sec_verse_newline_e8_e32")),  type=str, help="Path to Model")
