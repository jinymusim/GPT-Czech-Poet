...
parser.add_argument("--model_path", default=os.path.abspath(os.path.join(os.path.dirname(__file__), "BPE-gpt-cz-poetry-all-e128e128")),  type=str, help="Path to Model")
