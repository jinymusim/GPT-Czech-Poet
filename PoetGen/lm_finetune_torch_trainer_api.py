...
parser.add_argument("--model_path", default=os.path.abspath(os.path.join(os.path.dirname(__file__), "New-Syllable-BPE-NormalText-gpt-cz-poetry-all-e4e4")),  type=str, help="Path to Model")
