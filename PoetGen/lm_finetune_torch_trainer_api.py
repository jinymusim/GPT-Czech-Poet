...
parser.add_argument("--model_path", default=os.path.abspath(os.path.join(os.path.dirname(__file__), "gpt-cz-poetry-all_tasks_e8_e16")),  type=str, help="Path to Model")
