...
parser.add_argument("--tokenizer", default=os.path.abspath(os.path.join(os.path.dirname(__file__), "utils", "tokenizers", "Original", "base_tokenizer.json")), type=str, help="Tokenizer to use")
...
parser.add_argument("--model_path", default=os.path.abspath(os.path.join(os.path.dirname(__file__), "Base-Tokenizer-NormalText-gpt-cz-poetry-base-e16e16")),  type=str, help="Path to Model")
