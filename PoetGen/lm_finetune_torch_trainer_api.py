...
parser.add_argument("--model_path", default=os.path.abspath(os.path.join(os.path.dirname(__file__), "Llama2-cz-poetry-secondary_e4_e4")),  type=str, help="Path to Model")
