...
parser.add_argument("--model_path", default=os.path.abspath(os.path.join(os.path.dirname(__file__), "Unicode-Tokenizer-NormalText-gpt-cz-poetry-base-e8e16")),  type=str, help="Path to Model")
